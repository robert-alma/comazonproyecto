<h1>Revisión de Historial blablab de <strong>{{ $cliente->usuario->dato->nombre }}</strong> id:
    <strong>{{ $cliente->id }}</strong></h1>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center"><a
                                    href="{{ route('ejecutivo.cotizacion', $solicitud->id) }}"><button
                                        class="btn btn-info">Crear</button></a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
