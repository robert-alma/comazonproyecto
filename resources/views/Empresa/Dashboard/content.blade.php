                    ...
                    <tbody>
                        @foreach ($solicitudes as $solicitud)
                            <tr>
                                ...
                                <td><a href="{{ route('ejecutivo.cotizacion', $solicitud->id) }}"><button
                                            class="btn btn-primary btn-xs">Crear</button></a></td>
                                <td><a href="{{ route('ejecutivo.vercliente', $solicitud->id) }}"><button
                                            class="btn btn-info">Ver </button></a></td>
                            </tr>
                        @endforeach
                    </tbody>
                    <tfoot>
